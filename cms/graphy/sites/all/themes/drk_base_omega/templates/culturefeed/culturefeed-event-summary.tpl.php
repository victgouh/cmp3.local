...
<div class="event-teaser">
  <div class="content">
    <h2><?php print culturefeed_search_detail_l('event', $cdbid, $title, decode_entities($title), array('attributes' => array('id' => 'cf-title_' . $cdbid))); ?></h2>
    ...
    <?php if (!empty($tickets)): ?>
      <?php print culturefeed_search_detail_l('event', $cdbid, $title, t('Info & tickets'), array('attributes' => array('id' => 'cf-readmore_' . $cdbid))); ?>
    <?php else: ?>
      <?php print culturefeed_search_detail_l('event', $cdbid, $title, t('More info'), array('attributes' => array('id' => 'cf-readmore_' . $cdbid))); ?>
    <?php endif; ?>
  ...
  <div class="thumb">
    <?php if (!empty($thumbnail)): ?>
      <?php print culturefeed_search_detail_l('event', $cdbid, $title, '<img src="' . $thumbnail . '?width=320&height=240&crop=auto" />', array('attributes' => array('id' => 'cf-image_' . $cdbid), 'html' => TRUE)); ?>
    <?php endif; ?>
  </div>
</div>
