...
<article<?php print $attributes; ?>>
  <div<?php print $content_attributes; ?>>
    <div class="contact-and-map container mb20">
      <div class="contact">
        <div class="contact-wrapper">
          <div class="clearfix global-info test_class">
      ...
      <div class="map-info latest test_class">
        <?php print render($content["address_gmap"]); ?>
      </div>
    </div>

    <?php if(!empty($content["field_openingsuren"])) :?>

      <div class="container openinghours-extra mb20">
    ...
    <?php if(!empty($content["opening_hours_exception"])): ?>
      <div class="container adress-exceptions mb20">
        <?php print render($content["opening_hours_exception"]); ?>
      </div>
    <?php endif; ?>

    <?php if(!empty($content["field_item_onder_inhoud"])): ?>
      <div class="container">
        <?php print render($content["field_item_onder_inhoud"]); ?>
      </div>
    <?php endif; ?>

    <?php if(!empty($content["field_adres"])): ?>
      <div class="container">
        <?php print render($content["field_adres"]); ?>
      </div>
    <?php endif; ?> 

    <?php if(!empty($content["field_fotoalbum"])): ?>
      <div class="container">
